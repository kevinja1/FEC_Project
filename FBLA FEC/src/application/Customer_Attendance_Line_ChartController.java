...
public class Customer_Attendance_Line_ChartController implements Initializable{
	...
	public void addDataToXYChart(){
		...
		seriesAM.getData().add(new XYChart.Data<>("Wednesday", linechart.calcNumAMWednesday(week[3])));			seriesAM.getData().add(new XYChart.Data<>("Thursday", linechart.calcNumAMThursday(week[4])));
